...
class CreatePinForm(ModelForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields['title'].widget.attrs['placeholder'] = 'Добавьте название'
        self.fields['description'].widget.attrs['placeholder'] = 'Расскажите всем о чем ваш Пин...'
        self.fields['link'].widget.attrs['placeholder'] = 'Добавьте ссылку'
...
class CommentForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['text'].widget.attrs['placeholder'] = 'Добавьте комментарий'
        for visible in self.visible_fields():
